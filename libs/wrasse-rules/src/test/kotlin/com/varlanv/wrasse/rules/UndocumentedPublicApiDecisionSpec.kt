...
class UndocumentedPublicApiDecisionSpec :
    BaseSpec(
        {
            ...
            should("report an undocumented public function") {
                UndocumentedPublicApiDecision.decideFunction("foo", hasKdoc = false, isPublic = true, isOverride = false) shouldBe
                    "The function foo is missing documentation."
            }

            should("not report an undocumented public override function") {
                UndocumentedPublicApiDecision.decideFunction("foo", hasKdoc = false, isPublic = true, isOverride = true) shouldBe null
            }

            should("report an undocumented public property") {
                UndocumentedPublicApiDecision.decideProperty("foo", hasKdoc = false, isPublic = true, isOverride = false) shouldBe
                    "The property foo is missing documentation."
            }

            should("not report an undocumented public override property") {
                UndocumentedPublicApiDecision.decideProperty("foo", hasKdoc = false, isPublic = true, isOverride = true) shouldBe null
            }
        },
    )
