...
class RedundantVisibilityModifierDeletionSpanSpec :
    BaseSpec(
        {
            ...
            should("delete public and the single following space") {
                ...
                val edit = RedundantVisibilityModifierDeletionSpan.compute(source, publicStart, publicEnd, hasCommentInList = false)
            ...
            should("bail with no edit when the caller already found a comment inside the modifier list") {
                ...
                val edit = RedundantVisibilityModifierDeletionSpan.compute(source, publicStart, publicEnd, hasCommentInList = true)
