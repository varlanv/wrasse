...
class MixedConditionOperatorsDecisionSpec :
    BaseSpec(
        {

            should("report a chain using both && and ||") {
                MixedConditionOperatorsDecision.decide(hasAnd = true, hasOr = true) shouldBe MixedConditionOperatorsDecision.MESSAGE
            }
