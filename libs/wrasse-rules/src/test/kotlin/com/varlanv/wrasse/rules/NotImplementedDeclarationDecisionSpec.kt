...
class NotImplementedDeclarationDecisionSpec :
    BaseSpec(
        {

            should("report throwing NotImplementedError") {
                NotImplementedDeclarationDecision.decideThrow("NotImplementedError") shouldBe NotImplementedDeclarationDecision.MESSAGE
            }
