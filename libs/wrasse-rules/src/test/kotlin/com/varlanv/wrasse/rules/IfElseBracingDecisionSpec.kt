...
class IfElseBracingDecisionSpec :
    BaseSpec(
        {
            ...
            should("wrap a bare branch with no following sibling in braces via a leading and a zero-width trailing edit") {
                ...
                val verdict = IfElseBracingDecision
                    .decideBranch(source, candidate, baseIndentColumn = 4, indentWidth = 4, formatEnabled = false)
            ...
            should("wrap a bare branch with minimal, unindented edits when formatEnabled is true") {
                ...
                val verdict = IfElseBracingDecision
                    .decideBranch(source, candidate, baseIndentColumn = 4, indentWidth = 4, formatEnabled = true)
