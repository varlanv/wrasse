...
class PropertyNamingDecisionSpec : BaseSpec({
    should("accept lowerCamelCase non-const property") {
        PropertyNamingDecision.decide(
            "foo",
            hasConst = false,
    ...
    should("reject PascalCase non-const property") {
        PropertyNamingDecision.decide(
            ...
            isTopLevelVal = false,
            isObjectMemberVal = false,
        ) shouldBe PropertyNamingDecision.MESSAGE
    }
    ...
    should("reject camelCase const property") {
        PropertyNamingDecision.decide(
            ...
            isTopLevelVal = false,
            isObjectMemberVal = false,
        ) shouldBe PropertyNamingDecision.CONST_MESSAGE
    }
