...
private fun record(fqn: String, aliasName: String? = null, startOffset: Int = 0, endOffset: Int = fqn.length): ImportRecord =
ImportRecord(fqn = fqn, simpleName = fqn.substringAfterLast('.'), aliasName = aliasName, startOffset = startOffset, endOffset = endOffset)

class UnusedImportDecisionSpec :
    BaseSpec(
        {
