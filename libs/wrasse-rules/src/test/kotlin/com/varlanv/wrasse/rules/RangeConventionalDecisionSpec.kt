...
class RangeConventionalDecisionSpec :
    BaseSpec(
        {
            ...
            should("replace a rangeTo call with the .. operator") {
                ...
                RangeConventionalDecision
                    .decideRangeToCall(callStart = 0, callEnd = 20, receiverText = "a", argumentText = "b", hasComment = false)
            ...
            should("decline the rangeTo fix but still report when a comment is present") {
                val verdict =
                RangeConventionalDecision
                    .decideRangeToCall(callStart = 0, callEnd = 20, receiverText = "a", argumentText = "b", hasComment = true)
