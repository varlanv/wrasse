...
class TrimMultilineRawStringDecisionSpec : BaseSpec({

    should("report an untrimmed multiline raw string") {
        TrimMultilineRawStringDecision.decide(
            isRawWithLineBreak = true,
            isTrimmed = false,
            isExpectedAsConstant = false,
        ) shouldBe TrimMultilineRawStringDecision.MESSAGE
    }

    should("not report a single-line raw string") {
        TrimMultilineRawStringDecision.decide(
            isRawWithLineBreak = false,
            isTrimmed = false,
            isExpectedAsConstant = false,
        ) shouldBe null
    }
