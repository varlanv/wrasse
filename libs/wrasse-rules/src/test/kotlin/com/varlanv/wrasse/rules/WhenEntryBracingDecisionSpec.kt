...
class WhenEntryBracingDecisionSpec : BaseSpec({
    ...
    should("require both a braced sibling and a multiline entry to brace anything") {
        WhenEntryBracingDecision.shouldBraceEntries(
            anyEntryHasBlockBody = true,
            anyEntryHasMultilineBody = true,
        ) shouldBe true
        WhenEntryBracingDecision.shouldBraceEntries(
            anyEntryHasBlockBody = true,
            anyEntryHasMultilineBody = false,
        ) shouldBe false
        WhenEntryBracingDecision.shouldBraceEntries(
            anyEntryHasBlockBody = false,
            anyEntryHasMultilineBody = true,
        ) shouldBe false
        WhenEntryBracingDecision.shouldBraceEntries(
            anyEntryHasBlockBody = false,
