...
class WhenEntryBracingDecisionSpec :
    BaseSpec(
        {
            ...
            should("wrap a bare entry body in braces via a leading and a zero-width trailing edit") {
                ...
                val verdict = WhenEntryBracingDecision
                    .decideEntry(source, candidate, baseIndentColumn = 4, indentWidth = 4, formatEnabled = false)
            ...
            should("wrap a bare entry body with minimal, unindented edits when formatEnabled is true") {
                ...
                val verdict = WhenEntryBracingDecision
                    .decideEntry(source, candidate, baseIndentColumn = 4, indentWidth = 4, formatEnabled = true)
