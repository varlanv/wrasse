...
class ExceptionRaisedInUnexpectedLocationRule : WUninitializedRule {
    ...
    override fun initRule(config: WrasseRuleConfig): WNodeRule {
        ...
        return object : WNodeRule {
            ...
            override val targetTypes = setOf(WNodeType.FUN, WNodeType.THROW)
            ...
            override fun exitNode(ctx: WContext, reporter: WReporter) {
                ...
                val message = ExceptionRaisedInUnexpectedLocationDecision.decide(pending.name ?: "", pending.hasThrow) ?: return
