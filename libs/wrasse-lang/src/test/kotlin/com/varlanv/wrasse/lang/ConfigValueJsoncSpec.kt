    ...
    BaseSpec(
        {
            context("string values") {
                ...
                should("reject an unterminated string") {
                    shouldThrow<IllegalArgumentException> {
                            ...
                            .message shouldBe
                        "Unterminated string (line 1, column 7)"
                }
                ...
                should("reject an invalid escape sequence") {
                    shouldThrow<IllegalArgumentException> {
                            ...
                            .message shouldBe
                        "Invalid escape: \\x (line 1, column 3)"
                }
                ...
                should("reject an unescaped control character") {
                    shouldThrow<IllegalArgumentException> {
                            ...
                            .message shouldBe
                        "Unescaped control character in string (line 1, column 7)"
                }
                ...
                should("reject an incomplete unicode escape") {
                    shouldThrow<IllegalArgumentException> {
                            ...
                            .message shouldBe
                        "Incomplete unicode escape (line 1, column 3)"
                }
                ...
                should("reject an invalid unicode escape") {
                    shouldThrow<IllegalArgumentException> {
                            ...
                            .message shouldBe
                        "Invalid unicode escape: \\uZZZZ (line 1, column 3)"
                }
            }
            ...
            context("number values") {
                ...
                should("reject leading zeros") {
                    shouldThrow<IllegalArgumentException> {
                            ...
                            .message shouldBe
                        "Leading zeros not allowed (line 1, column 2)"
                }
                ...
                should("reject a bare minus sign") {
                    shouldThrow<IllegalArgumentException> {
                            ...
                            .message shouldBe
                        "Unexpected end in number (line 1, column 2)"
                }
                ...
                should("reject a decimal point without following digit") {
                    shouldThrow<IllegalArgumentException> {
                            ...
                            .message shouldBe
                        "Expected digit after '.' (line 1, column 3)"
                }
                ...
                should("reject an exponent without following digit") {
                    shouldThrow<IllegalArgumentException> {
                            ...
                            .message shouldBe
                        "Expected digit in exponent (line 1, column 3)"
                }
            }
            ...
            context("objects") {
                ...
                should("parse an object with multiple value types") {
                    val result = ConfigValueJsonc.parse("""{"s": "hello", "n": 42, "b": true, "d": 1.5, "nil": null}""").getOrThrow()
                    result.shouldBeInstanceOf<ConfigValue.Obj>()
                ...
                should("reject an unterminated object") {
                    shouldThrow<IllegalArgumentException> {
                            ...
                            .message shouldBe
                        "Unterminated object (line 1, column 8)"
                }
                ...
                should("reject a non-string key") {
                    shouldThrow<IllegalArgumentException> {
                            ...
                            .message shouldBe
                        "Expected string key, got '4' (line 1, column 2)"
                }
            ...
            context("arrays") {
                ...
                should("reject a mixed-type array") {
                    shouldThrow<IllegalArgumentException> {
                            ...
                            .message shouldBe
                        "Mixed array element types (line 1, column 23)"
                }
                ...
                should("reject nested arrays") {
                    shouldThrow<IllegalArgumentException> {
                            ...
                            .message shouldBe
                        "Mixed array element types (line 1, column 17)"
                }
                ...
                should("reject an unterminated array") {
                    shouldThrow<IllegalArgumentException> {
                            ...
                            .message shouldBe
                        "Unterminated array (line 1, column 6)"
                }
            }
            ...
            context("JSONC features") {
                ...
                should("reject unterminated block comments") {
                    shouldThrow<IllegalArgumentException> {
                            ...
                            .message shouldBe
                        "Unterminated block comment (line 1, column 15)"
                }
                ...
                should("not treat comment syntax inside strings as comments") {
                    ...
                    result.shouldBeInstanceOf<ConfigValue.Obj>()
                    result.value.get("url", ConfigValue.Str::class.java) shouldBe Property.Val(ConfigValue.Str("http://example.com"))
                }
            ...
            context("nesting depth") {
                ...
                should("reject objects nested beyond the maximum depth") {
                    val json = "{\"a\":".repeat(ConfigValueJsonc.MAX_DEPTH + 1) + "1" + "}".repeat(ConfigValueJsonc.MAX_DEPTH + 1)
                    shouldThrow<IllegalArgumentException> {
                                ConfigValueJsonc.parse(json).getOrThrow()
                            }
                            .message shouldBe
                        "Nesting exceeds ${ConfigValueJsonc.MAX_DEPTH} levels (line 1, column ${ConfigValueJsonc.MAX_DEPTH * 5 + 1})"
                }
                ...
                should("reject arrays nested beyond the maximum depth") {
                    ...
                    shouldThrow<IllegalArgumentException> {
                            ...
                            .message shouldBe
                        "Nesting exceeds ${ConfigValueJsonc.MAX_DEPTH} levels (line 1, column ${ConfigValueJsonc.MAX_DEPTH + 1})"
                }
            ...
            context("realistic config parsing") {
                ...
                """
                    ...
                    noSemicolons.value.value.get("enabled", ConfigValue.Bool::class.java) shouldBe Property.Val(ConfigValue.Bool(true))
                    noSemicolons.value.value.get("severity", ConfigValue.Str::class.java) shouldBe Property.Val(ConfigValue.Str("error"))
            ...
            context("error cases") {
                ...
                should("reject trailing content after a valid value") {
                    shouldThrow<IllegalArgumentException> {
                            ...
                            .message shouldBe
                        "Unexpected trailing content (line 1, column 4)"
                }
