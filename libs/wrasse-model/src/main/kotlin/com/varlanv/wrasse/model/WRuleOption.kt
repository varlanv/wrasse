 ...
 * simply absent from [WRuleOptions] in that case. [minimum] and [maximum] are the smallest and
 * largest values an [WRuleOptionType.INTEGER] option accepts; a value outside that range is a
 * configuration error.
 */
