...
private class RecordingGroup(override val ids: Set<String>, private val requiresQualifiedUsagesFlag: Boolean) : WUninitializedRuleGroup {
...
private fun errorConfig(exclude: List<java.nio.file.PathMatcher> = emptyList()) =
