 ...
 */
open class FqnImportInsertionSafetySpec :
    BaseSpec(
        {
            ...
            should("compile after the reconciliation case: an explicit import stays untouched while its qualified usage is rewritten") {
                val aux = TestSource(
                    "sample/aux/Aux.kt",
                    """
                        package sample.aux
