...
class Snapshot {
    ...
    fun isNotTouched(): Boolean {
        return indexPrice == null && markPrice == null && fundingRate == null && openInterest == null && topLongShortPositionRatio == null && longShortAccountRatio == null && bookTicker == null && priceChange24h == null
    }
}
